...
func TestExtract_Success(t *testing.T) {
				...
				Choices: []openai.ChatCompletionChoice{
					{
						Message: openai.ChatCompletionMessage{
							Content: `{"recruiter_first_name":"Jane","recruiter_last_name":"Smith","recruiter_email":"jane@google.com","company":"Google","job_title":"Staff Software Engineer","phone":"+16502530000","confidence":0.95}`,
						},
						FinishReason: "stop",
					},
				},
	...
	if result.JobTitle != "Staff Software Engineer" {
		t.Errorf("expected JobTitle=Staff Software Engineer, got %s", result.JobTitle)
	}
